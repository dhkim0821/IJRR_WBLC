...
data_y = np.genfromtxt('com_pos_des.txt', delimiter=None, dtype=(float))
...
fig.canvas.set_window_title('COM_POS_DES/TIME')
plt.xlabel('time')
plt.ylabel('com_pos_des')
plt.grid(True)
...
plt.plot(data_x, y1)
fig.canvas.set_window_title('COM_POS_DES1/TIME')
plt.xlabel('time')
plt.ylabel('com_pos_des')
plt.grid(True)
...
plt.plot(data_x, y2)
fig.canvas.set_window_title('COM_POS_DES2/TIME')
plt.xlabel('time')
plt.ylabel('com_pos_des')
plt.grid(True)
...
plt.plot(data_x, y3)
fig.canvas.set_window_title('COM_POS_DES3/TIME')
plt.xlabel('time')
plt.ylabel('com_pos_des')
plt.grid(True)
