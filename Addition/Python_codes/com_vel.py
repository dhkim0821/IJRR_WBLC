...
data_y = np.genfromtxt('com_vel.txt', delimiter=None, dtype=(float))
...
fig.canvas.set_window_title('COM_VEL/TIME')
plt.xlabel('time')
plt.ylabel('com_vel')
plt.grid(True)
...
plt.plot(data_x, y1)
fig.canvas.set_window_title('COM_VEL1/TIME')
plt.xlabel('time')
plt.ylabel('com_vel')
plt.grid(True)
...
plt.plot(data_x, y2)
fig.canvas.set_window_title('COM_VEL2/TIME')
plt.xlabel('time')
plt.ylabel('com_vel')
plt.grid(True)
...
plt.plot(data_x, y3)
fig.canvas.set_window_title('COM_VEL3/TIME')
plt.xlabel('time')
plt.ylabel('com_vel')
plt.grid(True)
