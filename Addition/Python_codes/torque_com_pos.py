...
## plot command/torque
fig = plt.figure(1)
plt.get_current_fig_manager().window.wm_geometry("480x800+0+0")
...
fig = plt.figure(2)
plt.get_current_fig_manager().window.wm_geometry("480x800+480+0")
...
## com_pos/com_pos_des
fig = plt.figure(3)
plt.get_current_fig_manager().window.wm_geometry("480x800+960+0")
