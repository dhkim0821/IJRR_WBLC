...
## read files
    ...
    for i in range(1,num_leg_joint + 1,1):
        ...
        plt.plot( \
                ...
                data_x, data_torque[st_idx:end_idx,i-1 + leg_jidx_start], "b-",\
                data_x, data_cmd[st_idx:end_idx, i-1 + leg_jidx_start], "r-")
    ...
    for i in range(1,num_leg_joint+1,1):
        ...
        plt.plot(\
                ...
                data_x, data_cmd[st_idx:end_idx,i-1 + num_leg_joint + leg_jidx_start], "r-" , \
                data_x, data_torque[st_idx:end_idx,i-1 + num_leg_joint + leg_jidx_start], "b-")
