    ...
    Kd_(atlas::num_act_joint)
{
    ...
    wblc_data_->tau_min_ = dynacore::Vector::Constant(atlas::num_act_joint, -200.);
    wblc_data_->tau_max_ = dynacore::Vector::Constant(atlas::num_act_joint, 200.);
...
void DoubleContactTransCtrl::CtrlInitialization(const std::string & setting_file_name){
    ini_jpos_ = sp_->Q_.segment(atlas::num_virtual, atlas::num_act_joint);
