...
void srDraco::_DefineVirtualJoint(){
  ...
  vp_joint_[jidx]->SetChildLinkFrame(EulerZYX(Vec3(0., SR_PI_HALF,0.), Vec3(0., -0.28, 0.)));
}
...
void srDraco::_DefineActuatedJoint(){
  ...
  r_joint_[jidx]->SetChildLink(link_[4]); // Lower Leg
