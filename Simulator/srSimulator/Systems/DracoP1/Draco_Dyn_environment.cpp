...
#include <Draco_Controller/StateProvider.hpp>
#include <Draco_Controller/interface.hpp>
...
void Draco_Dyn_environment::ContolFunction( void* _data ) {
  ...
  pDyn_env->interface_->GetCommand(alternate_time, jpos, jvel, jtorque, pos, body_vel, torque_command);
